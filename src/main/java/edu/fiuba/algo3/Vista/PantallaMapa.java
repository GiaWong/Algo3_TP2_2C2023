...
public class PantallaMapa extends BorderPane {
    ...
    public void mostrarMapa() {
            ...
            btnAvanzar.setOnAction(e -> {
              ...
              Pane circlesPane = new Pane(circle1, circle2, circle3, circle4, circle5, circle6);

              double centerX = (label.getMinWidth() - circlesPane.getBoundsInLocal().getWidth()) / 2;
              double centerY = (label.getMinHeight() - circlesPane.getBoundsInLocal().getHeight()) / 2;

              circlesPane.setLayoutX(centerX);
              circlesPane.setLayoutY(centerY);
